...
--ds_type=$ds_t --order_info=$order_info --ds_format=$ds_format --response_type=$response_type --results_dir="/project/MemN2N-split-memory/"
}
...
--log_predictions=True --dupi=$dupi --dupc=$dupc --results_dir="/project/MemN2N-split-memory/"
